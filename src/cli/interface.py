...
class CommandLineInterface:
    ...
    def _create_parser(self):
        ...
        parser.add_argument('--csv', default='image_library.csv', 
                          help='Path to CSV file (default: image_library.csv)')
        parser.add_argument('--tag', action='append', 
                          help='Tag criteria in format field=value, field>value, or field<value')
        parser.add_argument('--user-tag', action='append',
                          help='User tag to match')
        parser.add_argument('--polygon', 
                          help='Polygon coordinates as "lat1,lon1 lat2,lon2 lat3,lon3"')
        return parser
